...
<div class="page-wrapper">
	...
	<div class="page-header">
		<h1>💬 Leave a Treatment Comment</h1>
		<p>Add comments or prescriptions for patient appointments</p>
	</div>

	<!-- Form Section -->
	<div class="section">
		<div class="section-header">
			<h2>📝 Treatment Comment Form</h2>
		</div>
		<div class="section-content">
			...
			<form class="row g-3" action="../updateStatus" method="post">
				...
				<div class="col-md-6 form-group">
					...
					<input name="phone" type="number" maxlength="11" placeholder="Enter Mobile no." class="form-control" readonly value="<%= appointment.getPhone()%>">
				</div>

				<div class="col-md-6 form-group">
					<label class="form-label">Diseases</label>
					<input name="diseases" type="text" placeholder="Enter diseases" class="form-control" readonly value="<%= appointment.getDiseases()%>">
				</div>

				<div class="col-md-12 form-group">
					<label class="form-label">Leave a Comment / Prescription</label>
					<textarea name="comment" placeholder="Leave a comment" class="form-control" rows="3" maxlength="50" required title="Comment is required and cannot exceed 200 characters."></textarea>
				</div>
