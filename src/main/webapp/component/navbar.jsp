		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
				...
				<c:if test="${empty userObj}">
					...
					<li class="nav-item"><a class="nav-link active"
											aria-current="page" href="login.jsp">
						<i class="fas fa-sign-in-alt"></i> ITADMIN</a></li>
					<li class="nav-item"><a class="nav-link active"
											aria-current="page" href="stafflogin.jsp">
						<i class="fas fa-sign-in-alt"></i> STAFF</a></li>
					<li class="nav-item"><a class="nav-link active"
				...
				<c:if test="${not empty userObj }">
					...
					<li class="nav-item"><a class="nav-link active"
											aria-current="page" href="view_user.jsp"><i class="fa fa-calendar-check-o"></i> VIEW PROFILE</a></li>
					<li class="nav-item"><a class="nav-link active"
											aria-current="page" href="user_appointment.jsp"><i class="fa fa-calendar-check-o"></i> ADD APPOINMENT</a></li>
