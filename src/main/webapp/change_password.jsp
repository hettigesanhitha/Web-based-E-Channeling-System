		...
		<div class="section-content">
			...
			<form action="userChangePassword" method="post">
				<div class="form-group">
					...
					<input name="newPassword" type="password" placeholder="Enter new password" class="form-control" required minlength="6" maxlength="20" title="Password must be 6-20 characters">
				</div>
				<div class="form-group">
